	...
	: valid(true)
{
	...
	if(unformBufferShader->isLinked())
	{
		std::vector<std::string> elemNames =
		{
			...
			"Lights.SpotLights[4].Position", "Lights.SpotLights[4].Color", "Lights.SpotLights[4].Direction", "Lights.SpotLights[4].CutoffAngle", "Lights.SpotLights[4].Exponent", "Lights.SpotLights[4].ShadowMatrix",
			"Lights.SpotLights[5].Position", "Lights.SpotLights[5].Color", "Lights.SpotLights[5].Direction", "Lights.SpotLights[5].CutoffAngle", "Lights.SpotLights[5].Exponent", "Lights.SpotLights[5].ShadowMatrix",
			"Lights.SpotLights[6].Position", "Lights.SpotLights[6].Color", "Lights.SpotLights[6].Direction", "Lights.SpotLights[6].CutoffAngle", "Lights.SpotLights[6].Exponent", "Lights.SpotLights[6].ShadowMatrix",
			"Lights.SpotLights[7].Position", "Lights.SpotLights[7].Color", "Lights.SpotLights[7].Direction", "Lights.SpotLights[7].CutoffAngle", "Lights.SpotLights[7].Exponent", "Lights.SpotLights[7].ShadowMatrix",
